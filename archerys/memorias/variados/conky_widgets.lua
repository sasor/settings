...
function conky_widgets()
	...
	cr = cairo_create(cs)
        ...
        r = 75
        _r = 60
        rx = (2*r)*math.cos(math.pi/6)
        ry = (2*r)*math.sin(math.pi/6)

        ring('time', '%S', 60, 0xffffff, 0.2, 0xffffff, 0.8, r+rx, r, _r-(0*7), 5, 0, 360)
        ring('time', '%M', 60, 0xffffff, 0.2, 0xffffff, 0.8, r+rx, r, _r-(1*7), 5, 0, 360)
        ring('time', '%I', 12, 0xffffff, 0.2, 0xffffff, 0.8, r+rx, r, _r-(2*7), 5, 0, 360)
        clock_hands(r+rx, r+(0*ry), 0xffffff, 0.5, true, 70)

	ring('memperc',  '', 100, 0xffffff, 0.2, 0xffffff, 0.8, r, (1*r)+ry, _r-(0*7), 5, 0, 360)
	ring('swapperc', '', 100, 0xffffff, 0.2, 0xffffff, 0.8, r, (1*r)+ry, _r-(1*7), 5, 0, 360)

	ring('cpu', 'cpu0', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), r+(1*ry), _r-(0*7), 5,   0, 360)
	ring('cpu', 'cpu1', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), r+(1*ry), _r-(2*7), 5,   5,  85)
	ring('cpu', 'cpu2', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), r+(1*ry), _r-(2*7), 5,  95, 175)
	ring('cpu', 'cpu3', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), r+(1*ry), _r-(2*7), 5, 185, 265)
	ring('cpu', 'cpu4', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), r+(1*ry), _r-(2*7), 5, 275, 355)

        ring('battery_percent', '', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(0*rx), (3*r)+(1*ry), _r, 5, 0, 360)

	ring('fs_used_perc', '/',                      100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(0*7), 5,   5, 115)
	ring('fs_used_perc', '/boot',                  100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(0*7), 5, 125, 235)
	ring('fs_used_perc', '/home',                  100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(0*7), 5, 245, 355)	
        ring('fs_used_perc', '/tmp',                   100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(1*7), 5,   5, 115)
	ring('fs_used_perc', '/usr',                   100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(1*7), 5, 125, 235)
	ring('fs_used_perc', '/var',                   100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(1*7), 5, 245, 355)

	ring('fs_used_perc', '/usr/portage/distfiles', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(3*7), 5,   0, 360)
	ring('fs_used_perc', '/media/music',           100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(4*7), 5,  90, 450)
	ring('fs_used_perc', '/media/babel',           100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(5*7), 5, 180, 540)
	ring('fs_used_perc', '/media/resources',       100, 0xffffff, 0.2, 0xffffff, 0.8, r+(2*rx), (3*r)+(1*ry), _r-(6*7), 5, 270, 630)

        ring('mpd_percent', '',                                                                     100, 0xffffff, 0.2, 0xffffff, 0.8, r+(1*rx), (3*r)+(2*ry), _r-(0*7), 5, 0, 360)
        ring('exec',        'amixer get Master | egrep -o "[0-9]+%" | head -1 | egrep -o "[0-9]*"', 100, 0xffffff, 0.2, 0xffffff, 0.8, r+(1*rx), (3*r)+(2*ry), _r-(1*7), 5, 0, 360)
