...
app_firefox = "firefox"
--app_mplayer = "mplayer mms://200.58.71.7/canalfoxsports"
--app_liferea = "liferea"
app_pidgin = "pidgin"
app_gmpc = "gmpc"
--app_transmission = "transmission-gtk"
app_java_netbeans = "/opt/netbeans-java/bin/netbeans"
app_php_netbeans = "/opt/netbeans-php/bin/netbeans"
...
mymainmenu = awful.menu({ items = { --{ "awesome", myawesomemenu, beautiful.awesome_icon },
				    ...
				    { 'netbeans php',    app_php_netbeans,  beautiful.netbeans_icon },
				    { 'netbeans java',   app_java_netbeans, beautiful.netbeans_icon },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Mod1", "Control" }, "Left",  function () awful.client.moveresize(-20,  0,  0,  0) end),
    awful.key({ "Mod1", "Control" }, "Right", function () awful.client.moveresize( 20,  0,  0,  0) end),
    awful.key({ "Mod1", "Control" }, "Up",    function () awful.client.moveresize(  0,-20,  0,  0) end),
    awful.key({ "Mod1", "Control" }, "Down",  function () awful.client.moveresize(  0, 20,  0,  0) end),

    awful.key({ modkey, "Control" }, "Left",  function () awful.client.moveresize(-20,  0, 20,  0) end),
    awful.key({ modkey, "Control" }, "Right", function () awful.client.moveresize( 20,  0, 20,  0) end),
    awful.key({ modkey, "Control" }, "Up",    function () awful.client.moveresize(  0,-20,  0, 20) end),
    awful.key({ modkey, "Control" }, "Down",  function () awful.client.moveresize(  0, 20,  0, 20) end),

    awful.key({ modkey, "Shift" }, "Left",  function () awful.client.moveresize(-20,  0,-20,  0) end),
    awful.key({ modkey, "Shift" }, "Right", function () awful.client.moveresize( 20,  0,-20,  0) end),
    awful.key({ modkey, "Shift" }, "Up",    function () awful.client.moveresize(  0,-20,  0,-20) end),
    awful.key({ modkey, "Shift" }, "Down",  function () awful.client.moveresize(  0, 20,  0,-20) end),
